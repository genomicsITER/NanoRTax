...
tax_table_class.to_csv("centrifuge_report_class.csv", header=1, columns=["tax_id", "read_count"], index=False)
...
tax_table_order.to_csv("centrifuge_report_order.csv", header=1, columns=["tax_id", "read_count"], index=False)
...
tax_table_family.to_csv("centrifuge_report_family.csv", header=1, columns=["tax_id", "read_count"], index=False)
...
tax_table_genus.to_csv("centrifuge_report_genus.csv", header=1, columns=["tax_id", "read_count"], index=False)
...
tax_table_species.to_csv("centrifuge_report_species.csv", header=1, columns=["tax_id", "read_count"], index=False)
...
file1 = open("centrifuge_diversity_class.csv","w") 
...
file1 = open("centrifuge_diversity_order.csv","w") 
...
file1 = open("centrifuge_diversity_family.csv","w") 
...
file1 = open("centrifuge_diversity_genus.csv","w") 
...
file1 = open("centrifuge_diversity_species.csv","w") 
